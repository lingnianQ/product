package com.syt.product.interceptor.mybatis;
...
//        Interceptor.super.setProperties(properties);
     ...
     *
     * <p>注意,根据拦截器类型不同,获取BoundSql 的步骤并不相同,此处并未穷举所有方式</p>
     *
     * @param invocation
     * @return
     */
     ...
     */
    private void reflectAttributeValue(Object object, String attributeName, String attributeValue)
